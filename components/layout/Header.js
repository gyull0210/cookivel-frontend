...
export default function Header({isLogin, children}){
  return (
    <div className="w-full bg-white fixed z-50">
          ...
          <div className="flex-1 justify-center px-2 mx-2 gap-4 pl-20 lg:justify-start">
            ...
            <ul id="navbar-main" className="menu menu-horizontal hidden lg:flex">
              ...
              <li><a className="text-lg">자유연재</a></li>
              <li><a className="text-lg">작가연재</a></li>
              <li><a className="text-lg">리뷰게시판</a></li>
              <li><a className="text-lg">이벤트</a></li>
              <li><a className="text-lg">내서재</a></li>
            </ul>            
          </div>
          {isLogin ? 
